...
class Signal(BaseModel):
    ...
    module3_explanation: str
    module3_impact_assessment: str
        ...
        <div class="grid grid-cols-12 gap-8">
            ...
            <div class="col-span-4 space-y-8">
                <div class="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-sm">
                    <h3 class="text-xs font-black text-slate-400 uppercase tracking-widest mb-8">Departmental Impact</h3>
            ...
            container.innerHTML = signals.map(s => `
                <div id="card-${s.synthetic_id}" class="bg-white p-8 rounded-[2rem] border border-slate-200 card-hover relative overflow-hidden transition-all duration-300">
                    ...
                    <div class="bg-slate-50 rounded-2xl p-6 border border-slate-100 mb-8">
                        ...
                        <div class="space-y-2">
                             <p class="text-xs font-bold text-slate-800"><span class="text-slate-400">IMPACT:</span> ${s.module3_impact_assessment}</p>
                             <p class="text-xs font-medium text-slate-600 italic"><span class="not-italic font-bold text-slate-400">REASONING:</span> ${s.module3_explanation}</p>
